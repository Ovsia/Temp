...
# 路径设置
data_file = '/d/mqy/program2/evaluation/AMBER-master/data/query/query_all_converted.jsonl'
image_dir = '/d/mqy/program2/evaluation/image'
output_file = '/d/mqy/program2/LAVIS-main/projects/instructblip/7b-amber.json'
